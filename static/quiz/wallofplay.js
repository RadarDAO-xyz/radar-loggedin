    ...
    submissions.forEach(submission => {
        ...
        if (submission.attachment) {
            if (submission.attachment.type.startsWith('image')) {
                ...
                mediaElement = $(
                    `<audio controls controlsList="nodownload"><source src="${submission.attachment.url}" type="${submission.attachment.type}">Your browser does not support the audio element.</audio>`
                ).addClass('file-content');
            } else {
